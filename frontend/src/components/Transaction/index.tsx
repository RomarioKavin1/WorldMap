...
const myContractToken = "0xF0882554ee924278806d708396F1a7975b732522" as const;
const TestContractABI = [
  ...
  {
    inputs: [
      { internalType: "tuple", name: "permit", type: "tuple" },
      { internalType: "tuple", name: "transferDetails", type: "tuple" },
